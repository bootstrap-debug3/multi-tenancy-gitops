...
do
    ...
    do
        test -e 0-bootstrap/others/${CLUSTER}/${LAYER}/argocd && rm -r 0-bootstrap/others/${CLUSTER}/${LAYER}/argocd
        test -e 0-bootstrap/others/${CLUSTER}/${LAYER}/argocd && cp -a 0-bootstrap/single-cluster/${LAYER}/{argocd,${LAYER}.yaml,kustomization.yaml} 0-bootstrap/others/${CLUSTER}/${LAYER}/
